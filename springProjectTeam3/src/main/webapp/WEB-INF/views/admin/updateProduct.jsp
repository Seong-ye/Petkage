    ...
    <jsp:include page="../inc/admin_top.jsp"></jsp:include>
      <div class="content-wrapper">
         <div class="container-fluid">
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin/orderList">상품 수정</a>
                        </li>
                     </ol>
                  </div>
               </div>
            ...
            <!-- Header end -->
      <form action="${pageContext.request.contextPath}/admin/updateProductPro" method="post" enctype="multipart/form-data">	
            <div class="row">
               <div class="col-sm-10">                
                  <div class="card">
                        ...
                        <div class="row">
                           <div class="col-sm-10 table-responsive">                                                    
  							<div class="form-group row">
								    <label for="product_number" class="col-xs-2 col-form-label form-control-label">상품번호</label>
								    <div class="col-sm-5">
								        <input class="form-control" type="number" id="product_number" name="product_number" readonly value=${productDTODetail.product_number }>
								    </div>
								</div>																
								<div class="form-group row">
								    <label for="productCategory_number" class="col-xs-2 col-form-label form-control-label">카테고리 번호</label>
								    <div class="col-sm-5">
								        <input class="form-control" type="number" id="productCategory_number" name="productCategory_number"  value="${productDTODetail.productCategory_number }">
								    </div>
								</div>								 
								<div class="form-group row">
								    <label for="product_name" class="col-xs-2 col-form-label form-control-label">상품명</label>
								        <div class="col-sm-5">
								            <input class="form-control" type="text" id="product_name" name="product_name" value="${productDTODetail.product_name }">
								        </div>
								</div>								
								<div class="form-group row">
								    <label for="product_desc" class="col-xs-2 col-form-label form-control-label">상품 상세설명</label>
								        <div class="col-sm-5">
								            <input class="form-control" type="text" id="product_desc" name="product_desc" value="${productDTODetail.product_desc }">
								        </div>
								</div>																								 
								<div class="form-group row">
								...
								<div class="form-group row">
							    	<label for="product_price" class="col-xs-2 col-form-label form-control-label">가격</label>
							    		<div class="col-sm-5">
							        		<input class="form-control" type="number" id="product_price" name="product_price" value="${productDTODetail.product_price }">
							    		</div>
								</div>
								<div class="form-group row">
							    	<label for="product_stock" class="col-xs-2 col-form-label form-control-label">수량</label>
							    		<div class="col-sm-5">
							        		<input class="form-control" type="number" id="product_stock" name="product_stock" value="${productDTODetail.product_stock }">
							    		</div>
								</div>								
								<div class="form-group row">
								    <label for="product_date" class="col-xs-2 col-form-label form-control-label">상품 등록일</label>
								    <div class="col-sm-5">
           	 ...
           	 <input type="submit" class="btn btn-success waves-effect waves-light" value="상품정보 수정완료">    
            </form>
         </div>
      </div>
   </div>
