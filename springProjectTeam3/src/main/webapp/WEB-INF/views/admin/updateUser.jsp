...
<head>
   ...
   <script type="text/javascript">
	   function updateBtn(){
			...
			if(result){
				location.href='${pageContext.request.contextPath}/admin/updateUserInfoPro?user_id='+user_id;
...
<body class="sidebar-mini fixed">
   ...
   <div class="wrapper">        
    <jsp:include page="../inc/admin_top.jsp"></jsp:include>
      ...
      <form action="${pageContext.request.contextPath}/admin/updateUserInfoPro" method="post" enctype="multipart/form-data">	
            <div class="row">
               <div class="col-sm-10">                
                  <div class="card">
                           ...
                           <div class="form-group row">
								...
								<div class="form-group row">
								    <label for="user_name" class="col-xs-2 col-form-label form-control-label">이름</label>
								        <div class="col-sm-5">
								            <input class="form-control" type="text" id="user_name" name="user_name" value="${userDTODetail.user_name }">
								        </div>
								</div>
								...
								<div class="form-group row">
								    <label for="user_phone" class="col-xs-2 col-form-label form-control-label">휴대폰번호</label>
								        <div class="col-sm-5">
								            <input class="form-control" type="text" id="user_phone" name="user_phone" value="${userDTODetail.user_phone }">
								        </div>
								</div>
								...
								<div class="form-group row">
								        ...
								        <div class="col-sm-5">
								            <input class="form-control" type="text" id="user_email" name="user_email" value="${userDTODetail.user_email }">
								        </div>
								</div>  
           ...
           <input type="submit" class="btn btn-success waves-effect waves-light" value="회원정보 수정완료">    
           	 
          </form>
      	 <!--  <input  type="button" value="회원정보 수정완료" class="btn btn-success waves-effect waves-light" onclick="updateBtn();">  -->     
         </div>
      </div>
   </div>
</div>
